...
export async function loader({ request }: { request: Request }) {
    ...
    return { modelConfigs: modelConfigs || [] };
}
...
export default function Settings() {
    ...
    const { modelConfigs } = useLoaderData<typeof loader>();
    ...
    return (
        <div className="space-y-6">
            <ModelConfigurations modelConfigs={modelConfigs} />
            <Accounts />
        </div>
    );
}
...
function ModelConfigurations({ modelConfigs }: { modelConfigs: any[] }) {
    return (
        <ContentCard title="Model Configurations">
            {modelConfigs.length > 0 ? (
                        ...
                        {modelConfigs.map((config) => (
                            <div key={config.id} className="flex items-center justify-between py-3 px-4 bg-theme-surface-secondary rounded-lg">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-300">{config.model_id || 'No model specified'}</p>
                                </div>
                ...
                <div className="py-6 text-center">
                    ...
                    <button className="mt-4 px-4 py-2 bg-theme-primary hover:bg-theme-primary-hover rounded">
